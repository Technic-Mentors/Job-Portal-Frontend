          ...
          {currentJobSeekers?.length > 0 ? (
            ...
            <tr>
              <td colSpan="6" className="text-center">
                <strong>No Rejected Posts Available</strong>
              </td>
            </tr>
          )}
        </tbody>
...
export default RejectedJobSeekerPosts;
